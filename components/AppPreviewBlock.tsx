...
export default function AppPreviewBlock() {
  return (
    <section
      id="academy"
      className="bg-primary px-6 pt-6 pb-3 text-center text-onPrimary"
    >
      <Reveal>
        ...
        <p className="mx-auto mt-2 max-w-sm text-balance text-[0.95rem] font-medium text-onPrimary/80">
          Comprehensive video courses from Finqalab Academy, ready to watch right here.
        </p>
      </Reveal>
